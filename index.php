										...
										<tbody>
											<tr>
												<td style="min-width: 200px;">
													...
													<h2><a href="#">Asad Bin Khalid <span>Senior Software Engineer</span></a></h2>
												</td>                 
												<td>
													<h5 class="time-title p-0">Meeting Details</h5>
													<p>Dev Status meeting</p>
												</td>
												<td>
                            ...
                            <div class="card-body">
                                <ul class="contact-list">
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.php" title="John Doe"><img src="assets/img//ResizedImages/Siraj.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Siraj Munir</span>
                                                <span class="contact-date">Available</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.php" title="Richard Miles"><img src="assets/img//ResizedImages/Asim.jpg" alt="" class="w-40 rounded-circle"><span class="status offline"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Asim Farooq</span>
                                                <span class="contact-date">In a Call</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.php" title="John Doe"><img src="assets/img//ResizedImages/Anns.jpg" alt="" class="w-40 rounded-circle"><span class="status away"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Anns Ali</span>
                                                <span class="contact-date">Away</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="contact-cont">
                                            ...
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Out Of Her Mind</span>
                                                <span class="contact-date">Available</span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.php" title="Richard Miles"><img src="assets/img//ResizedImages/Asad.jpg" alt="" class="w-40 rounded-circle"><span class="status away"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Asad Bin Khalid</span>
                                                <span class="contact-date">Busy</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
