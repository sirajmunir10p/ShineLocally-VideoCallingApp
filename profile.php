                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">Asad Bin Khalid</h3>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href=""> 111-222-3344</a></span>
                                                </li>
                                                <li>
                                                    <span class="title">Email:</span>
                                                    <span class="text"><a href=""><span class="__cf_email__" data-cfemail="97f4e5fee4e3fef9f6f0e5f8e1f2e4d7f2eff6fae7fbf2b9f4f8fa">[email&#160;protected]</span></a></span>
                                                </li>
                                                <li>
                                                    <span class="title">Birthday:</span>
                                                    <span class="text">20th April</span>
                                                </li>
                                                <li>
                                                    <span class="title">Address:</span>
                                                    <span class="text">Iba Karachi</span>
                                                </li>
                                                <li>
                            ...
                            <div class="experience-box">
                                <ul class="experience-list">
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Institute of Business Administration(IBA)</a>
                                                <div>MSCS</div>
                                    ...
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Sir Syed University of Engineering and Technology (SSUET)</a>
                            ...
                            <div class="experience-box">
                                <ul class="experience-list">
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Senior Software Engineer (Shine Locally)</a>
                                                <span class="time">Jan 2021 - Present</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Software Engineer(Techlogix)</a>
                                                <span class="time">Jan 2020 - Jan 2021</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
